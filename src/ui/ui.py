...
class UI:
    def __init__(self, root):
        ...
        self.l1.pack()
        self.s1 = tk.Scale(self.f1, length=500, from_ = 0, to = 5000, resolution=10, orient="horizontal")
        self.s1.set(100) # Set the default value to 10
        self.s1.pack()
    ...
    def ui_generate_sequence(self):
        utils.seq = utils.generate_sequence(N=self.s1.get(), min_value=1, max_value=self.s1.get())
        print(f"DEBUG: Sequence: {utils.seq}")
